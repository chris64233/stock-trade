...
public record CreateOrderRequest(
        @NotNull(message = "clientOrderId 不能为空") String clientOrderId,
        @NotNull(message = "accountId 不能为空") String accountId,
        @NotNull(message = "symbol 不能为空") String symbol,
        @NotNull(message = "side 不能为空，只允许 BUY 或 SELL") OrderSide side,
